    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        try {
            if (type === 'sign-up') {
                ...
                const results = await signUp({ uid: userCredentials.user.uid, name: name!, email, password })
    ...
    return (
        <div className="card-border lg:min-w-[566px]">
            <div className="flex flex-col gap-6 card px-10 py-14">
                ...
                <h3 className='text-center'>Prepare interview with AI</h3>
                ...
                <p className='text-center'>
                    ...
                    <Link href={isSignIn ? '/sign-up' : '/sign-in'} className='font-blod text-user-primary ml-1'>
